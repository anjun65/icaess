        ...
        <div class="max-w-5xl px-6 py-16 mx-auto">
            ...
            <div class="grid gap-8 mt-10 md:mt-20 md:grid-cols-2">
                <div class="flex space-x-4">
                    ...
                    <div>
                        ...
                        <p class="max-w-lg mt-4 text-gray-600 pb-4">
                            Economic Development, Sharia Economy, Banking, Taxation, Commercial Insurance, Finance, Auditing, Governance and Internal Control System, Management Control System, Capital Market and Risk Management, Tax Management, International Tax, Management Information System, Quantitative Management Business, Management Strategy, Cost Management, Business Law, Operational Management, and Financial Management.
                        </p>
                    </div>
                </div>
                ...
                <div class="flex space-x-4">
                    ...
                    <div>
                        ...
                        <p class="max-w-lg mt-4 text-gray-600">
                            Accounting Theory, Sharia Accounting, Computer Accounting, Public Sector Accounting, Tax Accounting, Financial Accounting, Management Accounting and Budgeting, Cost Accounting, Accounting Information System, Accounting Practices of Commerce, Auditing, Governmental Accounting, Banking, International Accounting, Accounting Education, Social Accounting, Public Sector Accounting, Behavioural Accounting, and Accounting Technology.
                        </p>
                    </div>
                </div>
                ...
                <div class="flex space-x-4">
                    ...
                    <div>
                        <h4 class="text-xl font-medium text-gray-800">MANAGEMENT TRACK</h4>
                        <p class="max-w-lg mt-4 text-gray-600">
                            Sharia Management, Business Administration, Hotel Management, Logistics and Supply Chain Management, Sales and Marketing, Transportation Management, Industrial Management, Information Management¸ Retail Management, Secretariat, International Business, Trading and e-Commerce, Good Corporate Governance, Corporate Social Responsibility, Communication and Media Management, Stenography, Service Excellence, Office Management, Web Design, Quality Management, Human Resources Management, Business and Professional Ethics, Leadership and Change Management, Entrepreneurship and Business Plan, Project Management, Organizational Behavior and Culture, Entreprise Resources Planning, and Decision Making Analysis.
                        </p>
                    </div>
                </div>
                ...
                <div class="flex space-x-4">
                    ...
                    <div>
                        <h4 class="text-xl font-medium text-gray-800">SOCIAL SCIENCE TRACK</h4>
                        <p class="max-w-lg mt-4 text-gray-600">
                            Social Welfare, International Relations, Gender, Disability Studies, Public Policy, National Resilience, Development Studies, Regional Studies (ASEAN, Asia, etc.), Cultural Studies, Tourism, Competitiveness Studies, Religious Education in Industrial era 4.0 , English for Professional Communication, Computer-assisted Language Learning (CALL), and Citizenship Studies.
                        </p>
                    </div>
                </div>
            </div>
