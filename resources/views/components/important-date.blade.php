            ...
            <div class="card shadow-xl w-full lg:w-1/2">
                ...
                <tbody class="w-full">
                    ...
                    <tr tabindex="0" class="focus:outline-none h-20 text-sm leading-none text-gray-800 hover:bg-gray-100 border-b border-t border-gray-100">
                        ...
                        <td class="p-6">
                            <p class="text-sm font-medium leading-none text-gray-800"><div class="line-through">21 September 2022</div>3 October 2022</p>
                        </td>
                    </tr>
                    ...
                    <tr tabindex="0" class="focus:outline-none h-20 text-sm leading-none text-gray-800 hover:bg-gray-100 border-b border-t border-gray-100">
                        ...
                        <td class="p-6">
                            <p class="text-sm font-medium leading-none text-gray-800"><div class="line-through">24 August 2022</div>3 October 2022</p>
                        </td>
                    </tr>
